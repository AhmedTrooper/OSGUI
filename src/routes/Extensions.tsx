        ...
        <div class="flex items-center gap-3">
          ...
          <div class="text-left">
            ...
            <p class="text-[10px] text-zinc-400 dark:text-zinc-500 font-medium">
              Install browser link collectors, manage integrations, and review changelogs
            </p>
          </div>
        </div>
      </div>
          ...
          >
            ...
            <div class="space-y-1.5">
              ...
              <p class="text-[10px] text-zinc-400 dark:text-zinc-500 leading-relaxed font-semibold">
                Capture links automatically from Chrome, Firefox, or Brave. Install the official
                companion extension and speed up your workflow.
              </p>
            </div>
            ...
            <div class="pt-2 flex items-center gap-2 text-[9px] font-black text-blue-600 dark:text-blue-400 uppercase tracking-wider">
              ...
              <span class="flex items-center gap-1">
                <Coffee class="w-3.5 h-3.5" /> Buy Creator Coffee
              </span>
            </div>
          </div>
          ...
          <div class="border border-zinc-200/80 dark:border-zinc-800/80 bg-white dark:bg-zinc-950/20 p-4.5 rounded-2xl shadow-[0_2px_10px_rgba(0,0,0,0.01)] text-left space-y-3.5">
            ...
            <div class="space-y-3 text-[11px] font-medium font-sans">
              <div class="flex items-start gap-2.5">
                <span class="w-5 h-5 flex items-center justify-center bg-blue-500/10 dark:bg-blue-500/15 border border-blue-500/20 text-blue-600 dark:text-blue-400 font-black rounded-lg text-[10px] flex-shrink-0 mt-0.5">
                  1
                </span>
                <p class="text-zinc-500 dark:text-zinc-400 leading-relaxed">
                  Open the GitHub catalog using the card above and download the packed zip extension
                  bundle.
                </p>
              </div>
              <div class="flex items-start gap-2.5">
                ...
                <p class="text-zinc-500 dark:text-zinc-400 leading-relaxed">
                  Extract the bundle and load it under <strong>Developer Mode</strong> in your web
                  browser settings.
                </p>
              </div>
              <div class="flex items-start gap-2.5">
                ...
                <div class="text-left space-y-1">
                  <p class="text-zinc-500 dark:text-zinc-400 leading-relaxed">
                    The extension automatically streams links to the native Synclime daemon on local
                    API port:
                  </p>
              ...
              <div class="flex items-start gap-2.5">
                ...
                <p class="text-zinc-500 dark:text-zinc-400 leading-relaxed">
                  Verify captured items arrive in real-time inside your <strong>Inbox</strong> queue
                  catalog!
                </p>
              </div>
            </div>
          ...
          <div class="border border-zinc-200/80 dark:border-zinc-800/80 bg-white dark:bg-zinc-950/20 p-5 rounded-2xl shadow-[0_2px_10px_rgba(0,0,0,0.01)] flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div class="space-y-1 font-sans font-semibold">
              ...
              <p class="text-[10px] text-zinc-400 dark:text-zinc-500">
                Latest remote manifest version:{" "}
                <strong class="text-zinc-700 dark:text-white">v{latestVersionNum()}</strong>
              </p>
            </div>
            ...
            <Show
              ...
              fallback={
                <div class="py-12 text-center flex flex-col items-center justify-center space-y-2">
                  ...
                  <p class="text-zinc-400 text-xs font-semibold font-sans">
                    Syncing release manifestations...
                  </p>
                </div>
              }
            >
                      ...
                      <div class="relative space-y-2.5">
                        ...
                        <div class="bg-zinc-50 dark:bg-zinc-900/10 border border-zinc-200/60 dark:border-zinc-800/60 p-3.5 rounded-xl space-y-3 text-[11px] font-medium font-sans">
                          <Show when={update.features.length > 0}>
                            <div class="space-y-1">
                              <span class="text-[9px] uppercase font-black text-blue-600 dark:text-blue-400 tracking-wider">
                                Features Added
                              </span>
                          ...
                          <Show when={update.fixes.length > 0}>
                            <div class="space-y-1 pt-2.5 border-t border-zinc-250/20 dark:border-zinc-800/30">
                              <span class="text-[9px] uppercase font-black text-emerald-600 dark:text-emerald-400 tracking-wider">
                                Exceptions Fixed
                              </span>
                              <ul class="text-zinc-500 dark:text-zinc-400 space-y-1 list-none pl-1">
